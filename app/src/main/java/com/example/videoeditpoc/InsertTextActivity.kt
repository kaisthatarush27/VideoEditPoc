...
class InsertTextActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.insertGraphicActivity.setOnClickListener {
...
//            get the duration of the video
    ...
    private fun insertTextUsingFfmpeg() {
        ...
        val exe =
            "-i $input_video_uri_ffmpeg -vf \"drawtext=text='© Krishna':fontfile='$fontFile':x=(main_w-text_w-10):y=(main_h-text_h-10):fontsize=100:fontcolor=black:box=1:boxcolor=white@0.5:boxborderw=5\" ${file.absolutePath}"
